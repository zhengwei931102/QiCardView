...
- (void)initViews {
    ...
    _cardView = [[QiCardView alloc] initWithFrame:CGRectMake(50.0, 50.0, self.view.frame.size.width - 100.0, self.view.frame.size.height-100.0)];
    ...
    _cardView.interitemSpacing = 12.0;
    _cardView.maxAngle = 0.0;
    _cardView.isAlpha = YES;
    _cardView.maxRemoveDistance = 150.0;
